...
temp7 = read.csv2(paste0("data/json/2021-10-29/position.csv"))
temp7 = temp7 %>% filter(tag %in% names_tag_all$id)
temp8 = read.csv2(paste0("data/json/2021-10-30/position.csv"))
temp8 = temp8 %>% filter(tag %in% names_tag_all$id)

temp_tag = do.call(rbind.data.frame, list(temp1,temp2,temp3,temp4,temp5,temp6,temp7,temp8))
