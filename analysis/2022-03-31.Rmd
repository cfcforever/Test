...
ordered_tags = names(table(dat$tag))[order(table(dat$tag), decreasing = T)]
dat$tag = factor(dat$tag, levels = ordered_tags)
names_tag = names_tag[match(ordered_tags, names_tag$Identifiant),]
...
table_tag = table_tag[match(ordered_tags, table_tag$tag),]
...
table_diff_ts = table_diff_ts[match(ordered_tags, rownames(table_diff_ts)),]
...
table_sensibility = table_sensibility[match(ordered_tags, rownames(table_sensibility)),]
