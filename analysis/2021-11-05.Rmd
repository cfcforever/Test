...
temp1 = read.csv2(paste0("data/json/2021-10-28/position.csv"))
temp1 = temp1 %>% filter(tag %in% names_tag_all$id)
temp2 = read.csv2(paste0("data/json/2021-10-29/position.csv"))
temp2 = temp2 %>% filter(tag %in% names_tag_all$id)
temp3 = read.csv2(paste0("data/json/2021-10-30/position.csv"))
temp3 = temp3 %>% filter(tag %in% names_tag_all$id)
temp4 = read.csv2(paste0("data/json/2021-10-31/position.csv"))
temp4 = temp4 %>% filter(tag %in% names_tag_all$id)
temp5 = read.csv2(paste0("data/json/2021-11-01/position.csv"))
temp5 = temp5 %>% filter(tag %in% names_tag_all$id)
temp6 = read.csv2(paste0("data/json/2021-11-02/position.csv"))
temp6 = temp6 %>% filter(tag %in% names_tag_all$id)
temp7 = read.csv2(paste0("data/json/2021-11-03/position.csv"))
temp7 = temp7 %>% filter(tag %in% names_tag_all$id)
temp8 = read.csv2(paste0("data/json/2021-11-04/position.csv"))
temp8 = temp8 %>% filter(tag %in% names_tag_all$id)
temp9 = read.csv2(paste0("data/json/2021-11-05/position.csv"))
