...
dat = dat[which(dat$record_timestamp>=1633888800 & dat$record_timestamp<=1633892400),]
...
json_data = fromJSON(file = paste0("data/json/", today, "/20211010_2000_2100.json"))
dat <- data.frame(tag = unlist(lapply(json_data, function(x){x["tag_id"][[1]]})),
