...
for (k in c(1:2,4:10)){
  ...
  temp1 = read.csv2(paste0("data/json/2021-10-23/", tag, ".csv"))
  temp2 = read.csv2(paste0("data/json/2021-10-24/", tag, ".csv"))
  temp3 = read.csv2(paste0("data/json/2021-10-25/", tag, ".csv"))
  temp4 = read.csv2(paste0("data/json/2021-10-26/", tag, ".csv"))
  temp5 = read.csv2(paste0("data/json/2021-10-27/", tag, ".csv"))
  temp_tag = do.call(rbind.data.frame, list(temp1,temp2,temp3,temp4,temp5))
