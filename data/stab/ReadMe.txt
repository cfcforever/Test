...
- points: sous la forme matricielle dont sa dimension est égale à 10x2
  ...
  un exemple des dix points en mouvement: matrix(c(seq(from=0.2, to=2, by=0.2), rep(0,10)), byrow = F, ncol = 2)

- thres: le seuil pour distinguer si les points sont fixes ou en mouvement. 
  thres = 0.5 par défaut.
